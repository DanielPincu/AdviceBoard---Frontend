...
export default function Home() {
  ...
  useEffect(() => {
    ...
    // Removed state reset calls here as per instructions
    ...
    >
      ...
      {isAuthenticated && (
        <SearchBar
          ...
          searchAnonymousOnly={searchAnonymousOnly}
          setSearchAnonymousOnly={setSearchAnonymousOnly}
          ...
          setIsUnauthError={setIsUnauthError}
